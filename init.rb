...
CHECKLISTS_VERSION_NUMBER = '3.1.21'.freeze
...
Redmine::Plugin.register :redmine_checklists do
  ...
  Redmine::AccessControl.map do |map|
    map.project_module :issue_tracking do |map|
      map.permission :view_checklists, { checklists: %i[show index] }
      map.permission :done_checklists, { checklists: :done }
      map.permission :edit_checklists, { checklists: %i[done create destroy update] }
    end
  end
end
